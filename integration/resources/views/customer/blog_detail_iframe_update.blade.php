                ...
                <section class="blog-page section-padding">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form id="myForm" method="POST" action="/admin/blog/article/update" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" value="{{$article->bloc1}}" name="bloc1" id="bloc1">
                                    <input type="hidden" value="{{$article->id}}" name="id" id="id">
                                    <input type="hidden" value="{{$category}}" name="category" id="category">
                                    <input type="hidden" value="{{$article->bloc2}}" name="bloc2" id="bloc2">
                                    <input type="hidden" value="{{$article->bloc3}}" name="bloc3" id="bloc3">
                                                    ...
                                                    <div class=" video-card blog-header col-sm-4">
                                                        <div class="video-card-image">
                                                            ...
                                                            <a href="#"><img class="img-fluid"
                                                                    id="img-preview3" src="{{$article->image2}}"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                    <div class=" video-card blog-header col-sm-4">
                                                        <div class="video-card-image">
                                                            ...
                                                            <input type="file" name="image3"
                                                                ...
                                                                class="inputfile">
                                                            <a href="#"><img class="img-fluid"
                                                                    id="img-preview4" src="{{$article->image3}}"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-6 video-card blog-header col-sm-4">
                                                        <div class="video-card-image">
                                                            ...
                                                            <input type="file" name="image4"
                                                                ...
                                                                class="inputfile">
                                                            <a href="#"><img class="img-fluid"
                                                                    id="img-preview5" src="{{$article->image4}}"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 video-card blog-header col-sm-4">
                                                        <div class="video-card-image">
                                                            ...
                                                            <input type="file" name="image5"
                                                                ...
                                                                class="inputfile">
                                                            <a href="#"><img class="img-fluid"
                                                                    id="img-preview6" src="{{$article->image5}}"
                                                                    alt=""></a>
                                                        </div>
                                                    </div>
                                                </div>
