...
<body id="page-top">
    ...
    <div id="wrapper">
                @include('customer.partials.navbar', ['infos' => $subinfo, 'actif'=>7])
            ...
            <div class="container-fluid upload-details">
                ...
                <form method="POST" action="/settings" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <p>Charger une Photo de profil</p>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="imgplace">
                                <img class="img-fluid" id="img-preview" src="{{ Auth::user()->image }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-10">
                            <div class="osahan-title"> Nom : {{ Auth::user()->firstname }}</div>
                            <div class="osahan-size">Prenom : {{ Auth::user()->lastname }}</div>
                            <div class="osahan-size">Lien de Parraînage :<b> {!! url('/register?ref=' . old('', session('referral'))) !!}</b></div>
                            <div class="osahan-size">Filleuls :<b> {{$refs->successful_referrals}}</b></div>
                            <br>
                            <div class="osahan-size"><input class="form-control border-form-control" name="image"
                                    accept="image/*" type="file" onchange="getImage(this,'img-preview')"></div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Noms <span class="required">*</span></label>
                                <input class="form-control border-form-control" name="firstname"
                                    value="{{ Auth::user()->firstname }}" placeholder="Noms.." type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Prenoms <span class="required">*</span></label>
                                <input class="form-control border-form-control" name="lastname"
                                    value="{{ Auth::user()->lastname }}" placeholder="Prenoms.." type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Boîte Postale <span class="required">*</span></label>
                                <input class="form-control border-form-control" name="bp"
                                    value="{{ Auth::user()->BP }}" placeholder="bp" type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Company <span class="required">*</span></label>
                                <input class="form-control border-form-control" name="company"
                                    value="{{ Auth::user()->company }}" placeholder="Company" type="text">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control border-form-control" name="phone"
                                    value="{{ Auth::user()->phone }}" placeholder="(+237)..." type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control border-form-control" name="email"
                                    value="{{ Auth::user()->email }}" placeholder="iamosahan@gmail.com" disabled
                                    type="email" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select" value="{{ Auth::user()->country }}" id="country-select" name="country">
                                    ...
                                    <option value="Sierra Leo">Sierra Leone</option>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control border-form-control" name="city"
                                    value="{{ Auth::user()->city }}" placeholder="Ma ville de residence"
                                    type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button type="submit" class="btn btn-success border-none"> Sauvegarder </button>
                        </div>
                    </div>
                </form>
            </div>
