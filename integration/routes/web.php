...
Route::group(['namespace' => 'App\Http\Controllers'], function () { 
    ...
    Route::get('/mobile-pub', 'ClientController@mobilepub')->name('index.mobilepub');
    ...
    Route::get('/bundlepay/callback/{ref}', 'BundleController@handlePaymentCallback')->name('bundlepay.callback');
    ...
    Route::post('/transactions/check-status', 'TransactionController@checkStatus');
    Route::get('/transactions/check/{transactionReference}', 'TransactionController@getTransactionStatus');
});
